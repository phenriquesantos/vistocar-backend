...
def test_destroy():
    try:
        ...
        client_response = requests.delete(
            f"http://localhost:5000/api/client/1")
        schedule_response = requests.delete(
            f"http://localhost:5000/api/schedule/1")
        report_response = requests.delete(
            f"http://localhost:5000/api/report/1")
